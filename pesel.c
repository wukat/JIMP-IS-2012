...
int check(char pesel[]) //sprawdza znak kontrolny
{
	...
	error = 0;
	check = (1*pesel[0] + 3*pesel[1] + 7*pesel[2] + 9*pesel[3] + 1*pesel[4] 
	+ 3*pesel[5] + 7*pesel[6] + 9*pesel[7] + 1*pesel[8] + 3*pesel[9]) % 10; //modulo (%) 10
